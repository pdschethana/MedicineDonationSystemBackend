...
public class RecipientController {
    ...
    // e.g. GET /api/recipient/search/brand?name=Panadol&strength=500mg
    @GetMapping("/search/brand")
    public ResponseEntity<?> searchByBrandName(
            @RequestParam String name,
        ...
        try {
            return ResponseEntity.ok(ApiResponse.success(
                    "Search completed",
                    recipientService.searchByBrandName(name, strength)));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error(e.getMessage()));
        }
    ...
    // Search by API (generic) name + optional strength
    // e.g. GET /api/recipient/search/api?name=Paracetamol&strength=500mg
    @GetMapping("/search/api")
    public ResponseEntity<?> searchByApiName(
            @RequestParam String name,
            @RequestParam(required = false) String strength) {
        try {
            return ResponseEntity.ok(ApiResponse.success(
                    "Search completed",
                    recipientService.searchByApiName(name, strength)));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error(e.getMessage()));
        }
    ...
    public ResponseEntity<?> requestMedicine(
        ...
        try {
            String email = authentication.getName();
            return ResponseEntity.ok(ApiResponse.success(
                    "Medicine requested successfully. Please collect from collection point.",
                    recipientService.requestMedicine(donationId, email)));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error(e.getMessage()));
        }
    ...
    public ResponseEntity<?> getRequestById(
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success(
                    "Request retrieved",
                    recipientService.getRequestById(donationId, email)));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error(e.getMessage()));
        }
...
public class RecipientController {
    ...
    // Request medicine — optional body: { "requestedQuantity": 2 }
    @PostMapping("/request/{donationId}")
    public ResponseEntity<?> requestMedicine(
            @PathVariable Long donationId,
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success(
                    "Medicine requested successfully. Please collect from collection point.",
                    recipientService.requestMedicine(donationId, email, requestedQuantity)));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error(e.getMessage()));
        }
...
public class RecipientController {
    ...
    // Search by brand name + optional strength + optional collectionPointId
    // e.g. GET /api/recipient/search/brand?name=Panadol&strength=500mg&collectionPointId=1
    @GetMapping("/search/brand")
    public ResponseEntity<?> searchByBrandName(
            @RequestParam String name,
            @RequestParam(required = false) String strength,
        ...
        try {
            return ResponseEntity.ok(ApiResponse.success(
                    "Search completed",
                    recipientService.searchByBrandName(name, strength, collectionPointId)));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error(e.getMessage()));
        }
    ...
    // Search by API (generic) name + optional strength + optional collectionPointId
    // e.g. GET /api/recipient/search/api?name=Paracetamol&strength=500mg&collectionPointId=1
    @GetMapping("/search/api")
    public ResponseEntity<?> searchByApiName(
            @RequestParam String name,
            @RequestParam(required = false) String strength,
        ...
        try {
            return ResponseEntity.ok(ApiResponse.success(
                    "Search completed",
                    recipientService.searchByApiName(name, strength, collectionPointId)));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error(e.getMessage()));
        }
